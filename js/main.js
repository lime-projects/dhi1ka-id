		...
		if ( about.length > 0 ) {	
			...
			about.waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {
					...
					var sec = about.find('.to-animate').length,
		...
		if ( skill.length > 0 ) {
			skill.waypoint( function( direction ) {
				...
				if ( direction === 'down' && !$(this.element).hasClass('Animated') ) {
					...
					setTimeout(function() {
						skill.find('.to-animate').each(function(k) {
							var el = $(this);
					...
					setTimeout(function() {
						skill.find('.to-animate-2').each(function(k) {
							var el = $(this);
					...
					setTimeout(function() {
						skill.find('.to-animate-3').each(function(k) {
							var el = $(this);
